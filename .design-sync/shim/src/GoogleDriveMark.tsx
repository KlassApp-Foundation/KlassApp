...
/**
 * Official Google Drive logo mark. **Do not recolor** — the brand triangle
 * colors are baked into the path fills.
 *
 * Blade equivalent: `<x-brand.google-drive />`
