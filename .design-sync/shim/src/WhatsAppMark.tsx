...
/**
 * Official WhatsApp logo mark. **Do not recolor** — the brand green `#25D366`
 * is baked into the path fills.
 *
 * Blade equivalent: `<x-brand.whatsapp />`
 * (`resources/views/components/brand/whatsapp.blade.php`).
 */
export function WhatsAppMark({ decorative = true, className = '', style }: WhatsAppMarkProps) {
    return (
        <svg
            ...
            style={style}
        >
            {decorative ? null : <title>WhatsApp</title>}
            <path
                fill="#25D366"
