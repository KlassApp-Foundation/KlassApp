...
class User extends Authenticatable implements HasMedia
{
   ...
   // use HasMediaTrait;
     ...
     */
    protected $fillable = [
        'school_id' , 'usergroup_id' , 'ref_id' ,'name', 'email', 'password','mobile_no','is_activated', 'is_reset', 'email_verification_code' , 'email_verified' , 'email_verified_at' , 'platform_token' , 'remember_token', 'registration_role', 'teacher_designations', 'registration_number',
