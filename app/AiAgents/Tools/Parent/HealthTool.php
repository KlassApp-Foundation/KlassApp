...
class HealthTool implements Tool
{
    use AuthorizesParentToshiAction;

    public function description(): Stringable|string
    {
        return 'Show health incident records for a linked child. Optional child_name for disambiguation. Never accept student_id.';
    }
    ...
    public function handle(Request $request): Stringable|string
    {
        ...
        $result = ParentActionService::health($user, $request->get('child_name'));
