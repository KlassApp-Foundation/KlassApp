...
class GradesTool implements Tool
{
    ...
    {
        return 'Show exam grades/results for a linked child. Optional child_name for disambiguation. Never accept student_id.';
    }
    ...
    public function handle(Request $request): Stringable|string
    {
        ...
        $result = ParentActionService::grades($user, $request->get('child_name'));
