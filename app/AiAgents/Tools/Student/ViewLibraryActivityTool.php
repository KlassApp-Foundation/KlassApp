...
class ViewLibraryActivityTool implements Tool
{
    use AuthorizesStudentToshiAction;

    public function description(): Stringable|string
    {
        return 'List library lending activity for the signed-in student.';
    }
    ...
    public function handle(Request $request): Stringable|string
    {
        ...
        $result = StudentActionService::viewLibraryActivity($user);
