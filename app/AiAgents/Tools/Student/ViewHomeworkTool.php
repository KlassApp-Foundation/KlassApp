...
class ViewHomeworkTool implements Tool
{
    use AuthorizesStudentToshiAction;

    public function description(): Stringable|string
    {
        return 'List homework for the signed-in student class with own submission status.';
    }
    ...
    public function handle(Request $request): Stringable|string
    {
        ...
        $result = StudentActionService::viewHomework($user);
