...
class ViewClassWallTool implements Tool
{
    use AuthorizesStudentToshiAction;

    public function description(): Stringable|string
    {
        return 'Read-only class wall feed for the signed-in student school (no likes/comments).';
    }
    ...
    public function handle(Request $request): Stringable|string
    {
        ...
        $result = StudentActionService::viewClassWall($user);
