...
{{-- Pass-2 restyle. Verbatim CSRF/session copy from design audit / production-hit wording.
     Primary action = refresh (amber), not "Go Home". $exception available; copy stays static. --}}
