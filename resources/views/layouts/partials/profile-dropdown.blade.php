    ...
    <div class="user-dtl">
        <ul class="list-reset">
            ...
            <li class="user-dtl-item">
                <a href="{{ url($portalLinks['change_password']) }}" dusk="password-link">
                    <span class="dtl-icon">
            ...
            <li class="user-dtl-item">
                <a href="{{ url($portalLinks['edit_profile']) }}" dusk="edit-profile-link">
                    <span class="dtl-icon">
            ...
            <li class="user-dtl-item">
                <a href="{{ url($portalLinks['settings']) }}" dusk="settings-link">
                    <span class="dtl-icon">
