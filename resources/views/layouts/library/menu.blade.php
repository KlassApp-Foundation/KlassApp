...
<ul class="list-reset text-sm">
    ...
    <li class="py-3 px-3 hover:font-semibold {{ lActive(['books','book']) }}">
        <a href="{{ url('library/books/index') }}" class="flex items-center"><x-icons.sidebar name="library"/><span class="mx-3 whitespace-nowrap">Books</span></a>
    </li>
    ...
    <li class="py-3 px-3 hover:font-semibold {{ lActive(['borrowing','borrow','returns','return']) }}">
        <a href="{{ url('library/booklending/index') }}" class="flex items-center"><x-icons.sidebar name="reports"/><span class="mx-3 whitespace-nowrap">Borrowing</span></a>
    </li>
    <li class="py-3 px-3 hover:font-semibold {{ lActive(['reports','report']) }}">
        <a href="{{ url('library/activity') }}" class="flex items-center"><x-icons.sidebar name="reports"/><span class="mx-3 whitespace-nowrap">Data Exports</span></a>
    </li>
</ul>
