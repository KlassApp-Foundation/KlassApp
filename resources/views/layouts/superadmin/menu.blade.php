...
<ul class="list-reset text-sm">
    ...
    {{-- Settings --}}
    <li class="py-3 px-3 {{ superadminActive('settings') || Request::segment(3) == 'co-admins' || Request::segment(3) == 'cities' || Request::segment(3) == 'locations' || Request::segment(3) == 'features' || Request::segment(3) == 'emis' || Request::segment(2) == 'toshi' ? 'active' : '' }}">
