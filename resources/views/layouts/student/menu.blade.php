...
@php if(!function_exists('sActive')){function sActive($p){ $s=Request()->segment('2'); foreach((array)$p as $v) if($s===$v) return 'active'; return ''; }} @endphp
<ul class="list-reset text-sm">
    <li class="py-3 px-3 dashboard-menu-item {{ sActive('dashboard') }}">
    ...
    <li class="py-3 px-3 dashboard-menu-item {{ sActive(['notices','notice']) }}">
        <a href="{{ url('student/notices') }}" class="flex items-center"><x-icons.sidebar name="messages"/><span class="mx-3 whitespace-nowrap">Notices</span></a>
    </li>
    <li class="py-3 px-3 dashboard-menu-item {{ sActive(['libraryactivity','library']) }}">
        <a href="{{ url('student/libraryactivity') }}" class="flex items-center"><x-icons.sidebar name="library"/><span class="mx-3 whitespace-nowrap">Library</span></a>
    </li>
