...
<nav class="navbar dashboard-themed-header w-full flex  lg:flex-row px-4 lg:px-8 py-2 justify-between items-center">
  ...
  <div class="flex items-center">
    <notification url="{{url('/')}}" mode="teacher"></notification>
                ...
                <ul class="list-reset border shadow-lg" style="background-color: #0F172A; border-color: #334155;">
                  ...
                  <div class="py-2 leading-loose">
                    <li class="hover:bg-gray-700">
                      <a  href="{{url('/teacher/changepassword/')}}" dusk="password-link" class="text-sm  no-underline text-white px-3">
                        <span>Change Password</span>
                      </a>
                    </li>
                    <li class="hover:bg-gray-700">
                      <a href="{{url('/teacher/changeavatar')}}" class="text-sm  no-underline text-white px-3">
                        <span>Change Avatar</span>
                      </a>
                    </li>
                    @if(Auth::user()->isImpersonating())
                      <li class="hover:bg-gray-700">
                        <a href="{{ url('/teacher/impersonate/stop') }}" class="text-sm no-underline text-white flex px-2 py-1">
