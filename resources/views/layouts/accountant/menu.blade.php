...
<ul class="list-reset text-sm">
    ...
    <li class="py-3 px-3 hover:font-semibold {{ aActive(['fees','fee','payments','payment']) }}">
        <a href="{{ route('accountant.fee-payments') }}" class="flex items-center"><x-icons.sidebar name="fees"/><span class="mx-3 whitespace-no-wrap">Fees &amp; Payments</span></a>
    </li>
    <li class="py-3 px-3 hover:font-semibold {{ aActive(['reports','report']) }}">
        <a href="{{ route('accountant.reports') }}" class="flex items-center"><x-icons.sidebar name="reports"/><span class="mx-3 whitespace-no-wrap">Data Exports</span></a>
    </li>
    <li class="py-3 px-3 hover:font-semibold {{ aActive(['reports','report']) }}">
