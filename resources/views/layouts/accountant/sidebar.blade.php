...
<div id="admin-sidebar" class="w-full h-full lg:w-48 md:w-48 dashboard-themed-sidebar accountant-sidebar" data-collapsed="false">
  <div class="min-h-full header-wrapper-b hidden lg:block md:block">
   @include('layouts.partials.sidebar-menu', ['role' => 'accountant'])
  </div>
</div>
