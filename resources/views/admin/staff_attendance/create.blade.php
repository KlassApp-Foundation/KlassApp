...
@section('content')
    <div class="relative">
        <h1 class="admin-h1 my-3 flex items-center">
            <a href="{{route("admin.attendance.staff.list")}}" title="Back" class="rounded-full bg-gray-100 p-2">
        ...
        {{-- Vue-based staff attendance component replaced with blade form for one-by-one attendance. --}}
        {{-- <create-staff-attendance url="{{ url('/') }}" standard="{{ $standard }}" mode="admin"></create-staff-attendance> --}}
        @include('admin.staff_attendance.form')
    </div>
@endsection