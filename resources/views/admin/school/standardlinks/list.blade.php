                      ...
                      <tr class="border-t-2 border-b-2">    
                         ...
                         <td class="px-0 py-0" ><!-- width="23%" -->
                            @foreach($standardLink->teacherlink as $teacherlink)
                               <div class="flex items-center border">
                                  ...
                                  <p class="w-1/2 p-1 border-l">
                                     <a href="{{ url('/admin/teacher/show/'.$teacherlink->teacher->name) }}">
                         ...
                         <td class="py-3 px-2">
                            @if( $standardLink->status == 1)
                               <a href="#" rel="{{ url('/admin/standardLink/updateStatus/'.$standardLink->id) }}" class="status" value="0">
                            ...
                            @else
                               <a href="#" rel="{{ url('/admin/standardLink/updateStatus/'.$standardLink->id) }}" class=" status" value="1">
                         ...
                         <div class="flex items-center">
                            <a href="{{ url('/admin/standardLink/edit/'.$standardLink->id) }}" class="" title="Edit">
                            ...
                            <a href="{{ url('/admin/standardLink/show/'.$standardLink->id) }}" class="" title="Show">
                            ...
                            <a href="#" rel="{{ url('/admin/standardLink/delete/'.$standardLink->id) }}" class="delete" title="Delete">
                    ...
                    if (willChange) 
                    {
                        $.ajax({
                            ...
                            success:function(data)
                            {
                                swal({
                                    icon: "success",
                                    text: "Standard Details Status Updated Successfully",
                                }).then(function(){
