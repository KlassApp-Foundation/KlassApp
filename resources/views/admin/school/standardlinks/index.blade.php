        ...
        <div class="flex items-center gap-8">
                ...
                <div class="">
                    <div class="flex items-center">
                        {{-- ========== Levels =========== --}}
                        <a href="{{ url('/admin/standards') }}" class="no-underline text-white px-4 my-3 mx-1 flex items-center custom-green py-1 justify-center">
                            <span class="mx-1 text-sm font-semibold">Level(s)</span>
                           
                        </a>

                        {{-- classes --}}
                        <a href="{{ url('/admin/classes') }}" class="no-underline text-white px-4 my-3 mx-1 flex items-center custom-green py-1 justify-center">
                            <span class="mx-1 text-sm font-semibold">Classes</span>
                
                        </a>

                        {{-- standard link --}}
                          <a href="{{ url('/admin/standardLink/add') }}" class="no-underline text-white px-4 my-3 mx-1 flex items-center custom-green py-1 justify-center">
                            <span class="mx-1 text-sm font-semibold">Setup A Class</span>
            ...
            @endif
             ...
             {{-- <div class="">
                    <div class="flex items-center">
                        <a href="{{ url('/admin/classes/add') }}" class="no-underline text-white px-4 my-3 mx-1 flex items-center custom-green py-1 justify-center">
