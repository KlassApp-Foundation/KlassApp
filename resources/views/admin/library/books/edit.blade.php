...
<div class="dashboard-shell">
    <div class="dashboard-heading">
        <div>
            <h1 class="dashboard-section-title">Edit Book</h1>
            <p class="dashboard-subtitle">Update book details.</p>
        </div>
    ...
    <div class="ds-card max-w-2xl">
        <form method="POST" action="{{ route('admin.library.books.update', $book->id) }}">
            @csrf @method('POST')

            <div class="mb-4">
                <label class="ds-label" for="title">Title <span class="text-red-500">*</span></label>
                <input type="text" name="title" id="title" value="{{ old('title', $book->title) }}"
                       class="ds-form-input {{ $errors->has('title') ? 'ds-form-input-error' : '' }}" required>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                <div>
                    ...
                    <input type="text" name="book_code" id="book_code" value="{{ old('book_code', $book->book_code) }}"
                ...
                <div>
                    ...
                    <input type="text" name="isbn_number" id="isbn_number" value="{{ old('isbn_number', $book->isbn_number) }}"
            ...
            <div class="flex justify-end mt-6">
                ...
                <button type="submit" class="ds-btn ds-btn-primary">Update Book</button>
            </div>
        </form>
    </div>
</div>
