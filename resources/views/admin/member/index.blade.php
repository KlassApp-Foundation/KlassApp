                        ...
                        <td>
                            <div class="flex items-center gap-1">
                                <a href="{{ url('/admin/student/edit/' . $student->name) }}"
                                   class="p-1.5 rounded text-gray-400 hover:text-blue-600 hover:bg-blue-100 transition-colors"
                                   title="View Profile">
                                ...
                                <form action="{{ url('/admin/student/delete/' . $student->name) }}" method="POST" class="inline" onsubmit="return confirm('Delete this student?')">
                                    ...
                                    @method('DELETE')
                                    <button type="submit"
                                            class="p-1.5 rounded text-gray-400 hover:text-red-600 hover:bg-red-100 transition-colors"
                                            title="Delete">
