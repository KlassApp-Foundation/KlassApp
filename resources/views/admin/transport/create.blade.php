...
<div class="dashboard-shell">
    ...
    <div class="ds-card max-w-2xl">
        <form method="POST" action="{{ route('admin.transport.store') }}">
            @csrf

            <div class="mb-4">
                <label class="ds-label" for="name">Route Name <span class="text-red-500">*</span></label>
                <input type="text" name="name" id="name" value="{{ old('name') }}"
                       class="ds-form-input {{ $errors->has('name') ? 'ds-form-input-error' : '' }}"
                       placeholder="e.g. Kampala Route 1" required>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="vehicle_number" id="vehicle_number" value="{{ old('vehicle_number') }}"
                       class="ds-form-input {{ $errors->has('vehicle_number') ? 'ds-form-input-error' : '' }}"
                       placeholder="e.g. UBA 123K" required>
            ...
            <div class="mb-4">
                ...
                <textarea name="stops" id="stops" rows="4"
                          class="ds-form-input {{ $errors->has('stops') ? 'ds-form-input-error' : '' }}"
                          placeholder="One stop per line, e.g.&#10;1. Kampala City Center&#10;2. Ntinda&#10;3. Kyambogo" required>{{ old('stops') }}</textarea>
            ...
            <div class="flex gap-2">
                <button type="submit" class="ds-btn ds-btn-primary">Create Route</button>
