<div class="overflow-x-auto">
    <table class="min-w-full divide-y divide-gray-200 text-sm">
        <thead class="bg-gray-50">
            <tr>
                <th class="p-2 text-left font-medium text-gray-500 uppercase tracking-wider">ID</th>
                <th class="p-2 text-left font-medium text-gray-500 uppercase tracking-wider">Student</th>
