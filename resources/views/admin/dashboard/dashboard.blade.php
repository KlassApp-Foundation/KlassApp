                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <a href="{{ url('/admin/students') }}">
                            <div class="bg-white custom-shadow px-5 py-4 border dashboard-kpi-card">
                                <div class="w-16 h-16 rounded-full bg-light-green flex items-center justify-center mx-auto text-green-500 dashboard-kpi-icon">
                    ...
                    <a href="{{ url('/admin/teachers') }}">
                            <div class="bg-white custom-shadow px-5 py-4 border dashboard-kpi-card">
                                <div class="w-14 h-14 rounded-full bg-light-blue flex items-center justify-center mx-auto text-blue-500 dashboard-kpi-icon">
                    ...
                    <a href="{{ url('/admin/parents') }}">
                            <div class="bg-white custom-shadow px-5 py-4 border dashboard-kpi-card">
                                <div class="w-14 h-14 rounded-full bg-light-orange flex items-center justify-center mx-auto text-orange-500 dashboard-kpi-icon">
                    ...
                    <a href="{{ url('/admin/staffs') }}">
                            <div class="bg-white custom-shadow px-5 py-4 border dashboard-kpi-card">
                                <div class="w-14 h-14 rounded-full bg-light-red flex items-center justify-center mx-auto text-red-500 dashboard-kpi-icon">
