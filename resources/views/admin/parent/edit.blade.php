  ...
  <div class="w-full">
    <div>
      <h1 class="admin-h1 my-3 flex items-center">
        <a href="{{ url('/admin/parent/show/'.$user->name) }}" title="Back" class="rounded-full bg-gray-100 p-2">
        ...
        <span class="mx-3">Edit Parent</span>
      </h1>
    </div>
    ...
    <form method="POST" action="{{url('/admin/parent/edit/'.$user->name)}}" enctype="multipart/form-data">
        ...
        <portal to="edit_official_address">
          <div class="flex flex-col lg:flex-row md:flex-row">
            <div class="tw-form-group w-full lg:w-1/2 md:w-1/2">
              <div class="lg:mr-8 md:mr-8">
                <div class="mb-2">
                  <label for="address" class="tw-form-label">Official Address</label>
                </div>
                <div class="mb-2 w-full relative">
                  <input type="text" name="address" class="tw-form-control w-full" id="address" value="{{ $parentprofile['official_address'] }}">
