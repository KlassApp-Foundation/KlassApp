...
@section('content')
   <div class="relative">
      <div class="flex flex-col lg:flex-row md:flex-row justify-between">
         <div class="">
            <h1 class="admin-h1 my-3">Book Category Details</h1>
         </div>
         ...
         <div class="relative flex items-center w-1/4 lg:justify-end">
            ...
            <div class="flex items-center">
               <a href="{{url('/library/bookscategory/add')}}" class="no-underline text-white px-4 my-3 mx-1 flex items-center custom-green py-1 justify-center whitespace-nowrap">
                  <span class="mx-1 text-sm font-semibold">Add Book Category</span>
    ...
    C21.517,9.026,21.517,14.63,18.073,18.074z"></path></g></svg>
     ...
     @include('library.bookscategory.list')
