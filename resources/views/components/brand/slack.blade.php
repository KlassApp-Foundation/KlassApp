...
{{-- Official Slack logo mark (2019 hash). Do not recolor. Brand colors: aubergine accents #E01E5A #36C5F0 #2EB67D #ECB22E. --}}
<svg {{ $attributes->class(['brand-mark', 'brand-mark--slack'])->merge([
