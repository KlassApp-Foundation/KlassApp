...
@section('content')
    ...
    <div class="dashboard-shell dashboard-shell--student">
        <p class="dashboard-subtitle">Track attendance, upcoming events, notices, and class activity in one view.</p>
        <!-- start -->
                ...
                <div class="bg-white custom-shadow  border my-1 mx-1 rounded">
                    <div class="student_bg px-4 py-3 rounded-t flex">
                        ...
                        <div class="mx-5">
                            ...
                            <p class="text-white  text-sm py-1">{{ Auth::user()->studentAcademicLatest->std_school_pay_number }}</p>
