...
@section('content')
    <div class="relative">
        <div class="flex flex-wrap lg:flex-row justify-between">
            <div class="">
                <h1 class="admin-h1 my-3">My Leave Applications</h1>
            </div>
                ...
                <div class="flex items-center w-full justify-end">
                    <div class="flex items-center">
                        <a href="{{ url('/teacher/leave/add') }}" class="no-underline text-white px-4 my-3 mx-1 flex items-center custom-green py-1 justify-center">
                            <span class="mx-1 text-sm font-semibold whitespace-nowrap">Add Leave</span>
        ...
        <leave-teacher-list url="{{ url('/') }}" type="apply" mode="myleaves"></leave-teacher-list>
    </div>
@endsection