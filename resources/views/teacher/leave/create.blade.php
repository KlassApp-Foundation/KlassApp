...
@section('content')
	<div class="relative">
      <div class="flex flex-wrap lg:flex-row justify-between">
         <div>
            <div class="ds-page-head"><h1 class="ds-page-head-title">
               <a href="{{ url('/teacher/leaves') }}" title="Back" class="rounded-full bg-gray-100 p-2">
               ...
               <span class="mx-3">Add Leave Application</span>
            </h1>
         </div>
      </div>
      @include('partials.message')
      <create-leave url="{{ url('/') }}"></create-leave>
   </div>
@endsection