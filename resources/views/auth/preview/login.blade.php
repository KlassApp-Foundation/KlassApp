...
{{-- Preview restyle of auth/login. Forms POST to real /login.
     Layout: OD klassapp-auth-error-vintage-paper-v2-breakpoints (desktop split / mobile stack). --}}
@extends('layouts.auth-preview')

@section('title', 'Sign in')

@section('content')
<div class="ap-page" data-ap-paper="vintage" data-ap-layout="split" data-ap-screen="login">
