...
@section('content')
<div class="ap-page" data-ap-paper="vintage" data-ap-layout="split" data-ap-screen="reset-newpw">
  @include('auth.preview._paper-bg')
  <div class="ap-shell">
    @include('auth.preview._brand-panel', [
      'tagline' => 'Choose a strong password',
      'support' => 'Use something only you know. You will sign in with it next.',
    ])
