...
@section('content')
<div class="ap-page" data-ap-paper="vintage" data-ap-layout="split" data-ap-screen="force-change-password">
  @include('auth.preview._paper-bg')
  <div class="ap-shell">
    @include('auth.preview._brand-panel', [
      'tagline' => 'Update your temporary password',
      'support' => 'Required before you can continue. This step cannot be bypassed.',
    ])
