...
@section('content')
<div class="ap-page" data-ap-paper="vintage" data-ap-layout="split" data-ap-screen="reset-request">
  @include('auth.preview._paper-bg')
  <div class="ap-shell">
    @include('auth.preview._brand-panel', [
      'tagline' => 'Reset with a short code',
      'support' => 'We email a 6-digit code so you can set a new password securely.',
    ])
