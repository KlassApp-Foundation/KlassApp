...
@section('content')
<div class="ap-page" data-ap-paper="vintage" data-ap-layout="split" data-ap-screen="reset-code">
  @include('auth.preview._paper-bg')
  <div class="ap-shell">
    @include('auth.preview._brand-panel', [
      'tagline' => 'Check your inbox',
      'support' => 'Enter the 6-digit code we sent, then choose a new password.',
    ])
