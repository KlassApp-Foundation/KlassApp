...
@section('content')
<div class="ap-page" data-ap-paper="vintage" data-ap-layout="split" data-ap-screen="register">
  @include('auth.preview._paper-bg')
  <div class="ap-shell">
    @include('auth.preview._brand-panel', [
      'tagline' => 'Start your school on KlassApp',
      'support' => 'Create an account, then finish setup with Toshi.',
    ])
    <div class="ap-form-panel">
      <div class="ap-form-shell ap-card ap-card--wide">
