<template>
	<div>
		...
		<div class="flex flex-col lg:flex-row">
   			<div class="flex flex-wrap w-full lg:w-full lg:mr-3 my-2">
      			<div class="bg-white shadow border border-grey px-5 py-3 w-full">
	   				<div class="flex flex-wrap lg:flex-row justify-between mb-2">
				        <div class="">
				            <h1 class="admin-h1">{{ page.page_name }}</h1>
				        </div>
				        <div class="relative flex items-center justify-end" v-if="mode == 'admin'">
				            <div class="flex items-center">
				                <a href="#" @click="showsidebar(id)" class="no-underline text-white flex items-center bg-white rounded-full py-1 justify-center">
				            ...
				            <div :id="id" class="hidden absolute bg-white w-20 shadow right-0 top-0 my-6 rounded">
				                <div class="flex flex-col text-xs  my-1">
				                    <a :href="url+'/classwall/page/edit/'+page.id" class="capitalize text-gray-700 rounded px-4 py-1 mr-2 font-medium" target="_blank">edit</a>
		          		...
		          		<div class="flex items-center">
		          			<div class="mr-6">
								<div class="flex flex-wrap items-center">
			          				<a href="#" @click="like(id,1)" v-if="page.like == null || page.like == 0" title="Like">
			          				...
			          				<a href="#" @click="like(id,0)" v-if="page.like == 1" title="Liked">
		          			...
		          			<div class="mr-6">
								<div class="flex flex-wrap">
			          				<a href="#" @click="dislike(id,1)" v-if="page.dislike == null || page.dislike == 0" title="Dislike">
			          				...
			          				<a href="#" @click="dislike(id,0)" v-if="page.dislike == 1" title="Disliked">
		          			...
		          			<div class="flex items-center">
		          			<div class="text-sm">
		          				<a href="#" class="no-underline text-white px-4 mx-1 flex items-center bg-red-600 justify-center rounded" v-if="page.is_following == 0 || page.is_following == null" @click="following(id,1)" title="Follow">Follow</a>
		          				<a href="#" class="no-underline text-white px-4 mx-1 flex items-center custom-green justify-center" v-if="page.is_following == 1" @click="following(id,0)" title="Following">Following</a>
		          			</div>

		          			<div class="">
		          				<a :href="url+'/'+mode+'/classwall/post/add?entity_name='+entity_name+'&entity_id='+entity_id" class="no-underline text-white px-4 mx-1 flex items-center custom-green justify-center" target="_blank" title="Create Post">
		          					<span class="mx-1 text-sm font-semibold">Create Post</span>
