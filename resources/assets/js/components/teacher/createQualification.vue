<template>
    <div
        class="overflow-x-scroll lg:overflow-x-auto md:overflow-x-auto py-3 bg-white shadow px-3"
        v-bind:class="[this.profile_tab == 2 ? 'block' : 'hidden']"
    >
        <div class="flex flex-col lg:flex-row">
            <div class="tw-form-group w-full lg:w-1/3 hidden">
                <div class="lg:mr-8 md:mr-8">
                    <div class="mb-2">
                        <label for="ug_degree" class="tw-form-label"
                            >UG degree</label
                        >
                    </div>
                    <div class="mb-2">
                    ...
                    <span
                        v-if="errors.ug_degree"
                        class="text-red-500 text-xs font-semibold"
                        >{{ errors.ug_degree[0] }}</span
                    >
                </div>
            </div>
            ...
            <div class="tw-form-group w-full lg:w-1/3 hidden">
                <div class="lg:mr-8 md:mr-8">
                    <div class="mb-2">
                        <label for="pg_degree" class="tw-form-label"
                            >PG degree</label
                        >
                    </div>
                    <div class="mb-2">
                    ...
                    <span
                        v-if="errors.pg_degree"
                        class="text-red-500 text-xs font-semibold"
                        >{{ errors.pg_degree[0] }}</span
                    >
                </div>
            </div>
            ...
            <div class="tw-form-group w-full lg:w-1/3">
                <div class="lg:mr-8 md:mr-8">
                    <div class="mb-2">
                        <label for="specialization" class="tw-form-label"
                            >Subject Specialization<span class="text-red-500"
                                >*</span
                            ></label
                        >
                    </div>
                ...
                <div class="lg:mr-8 md:mr-8">
                    ...
                    <div class="mb-2">
                        ...
                        >
                            ...
                            <option
                                v-for="qualifications in qualificationlist"
                                v-bind:value="qualifications.id"
                            >
                    ...
                    <span
                        v-if="errors['qualification_id' + index]"
                        class="text-red-500 text-xs font-semibold"
                        >{{ errors["qualification_id" + index] }}</span
                    >
                </div>
                <a
                    href="#"
                    class="btn-times"
                    v-show="index || (!index && input.length > 1)"
        ...
        <div class="flex flex-col lg:flex-row">
            <div class="tw-form-group w-full lg:w-1/3">
                <div class="lg:mr-8 md:mr-8">
                    <div class="mb-2">
                        <label for="add_qualification" class="tw-form-label"
                            >Add New</label
                        >
                    </div>
                    <div class="mb-2">
        ...
        submitForm(val) {
            ...
            for (let i = 0; i < this.inputs.length; i++) {
                if (typeof this.inputs[i]["qualification_id"] !== "undefined") {
                    formData.append(
                        "qualification_id" + i,
                        this.inputs[i]["qualification_id"]
                    );
                } else {
            ...
            if (this.type == "add") {
                axios
                    .post(
                        "/admin/teacher/add/validationQualification",
                        formData,
                ...
                axios
                    .post(
                        "/admin/teacher/edit/validationQualification/" +
                            this.teacher_name,
                        formData,
                        { headers: { "Content-Type": "multipart/form-data" } }
                    )
