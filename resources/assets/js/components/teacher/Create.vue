<template>
    ...
    >
        ...
        <div class="flex flex-col lg:flex-row">
            ...
            <div
                class="tw-form-group w-full lg:w-1/4"
                ...
                <div class="lg:mr-8 md:mr-8">
                    <div class="mb-2">
                        <label for="mobile_no" class="tw-form-label"
                            >Mobile Number<span class="text-red-500"
                                >*</span
                            ></label
                        >
                    </div>
        ...
        <div class="my-6">
            <a
                ...
                >Submit</a
            >
            <a href="#" class="btn-reset reset-btn" @click="resetForm()"
                >Reset</a
            >
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        uploadImage() {
            ...
            axios
                .post("/admin/teacher/add/validationAvatar", formData, {
        ...
        submitForm(val) {
            ...
            axios
                .post("/admin/teacher/add/validationProfile", formData, {
                    headers: { "Content-Type": "multipart/form-data" },
                })
                .then((response) => {
