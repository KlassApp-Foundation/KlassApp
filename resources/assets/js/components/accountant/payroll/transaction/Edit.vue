        ...
        <div>
            ...
            <div class="flex flex-wrap">
                <div class="w-full lg:w-1/2 md:w-1/2">
                    ...
                    <span
                        v-if="errors.paytype_id"
                        class="text-red-500 text-xs font-semibold"
                        >{{ errors.paytype_id[0] }}</span
                    >
                </div>
                    ...
                    <div class="lg:mr-6 md:mr-6">
                        ...
                        <div class="my-1">
                            ...
                            /><span
                                ...
                                class="text-red-500 text-xs font-semibold"
                                >{{ errors.transaction_date[0] }}</span
                            >
                        </div>
                    </div>
                </div>
            ...
            <div v-if="this.payment_method == 'Bank'" class="w-full lg:w-1/2">
                <div class="lg:mr-8 md:mr-8 mb-2">
                    ...
                    /><span
                        ...
                        class="text-red-500 text-xs font-semibold"
                        >{{ errors.reference_number[0] }}</span
                    >
                </div>
            </div>
...
export default {
    ...
    methods: {
        getList() {
            axios
                .get(this.url + "/accountant/payroll/transaction/showlist")
                .then((response) => {
        ...
        getdetails() {
            axios
                .get(
                    this.url +
                        "/accountant/payroll/transaction/" +
                        this.transaction_id +
                        "/editshow"
                )
                .then((response) => {
                    ...
                    if (this.editdata.payment_method == "Cheque") {
                        this.cheque_number =
                            this.editdata.transaction_detail.cheque_number;
                        this.cheque_date =
                            this.editdata.transaction_detail.cheque_date;
                        this.clearnig_date =
                            this.editdata.transaction_detail.clearnig_date;
                        this.cheque_bank =
                            this.editdata.transaction_detail.cheque_bank;
                    }
