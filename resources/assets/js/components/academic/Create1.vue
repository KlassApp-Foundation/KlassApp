    ...
    <div class="bg-white shadow px-4">
      ...
      <div class="modal-wrapper px-4">
            ...
            <div class="modal-wrapper px-4">
                <div class="modal-container w-full max-w-md px-8 mx-auto">
                    ...
                    <div class="modal-body">
                        <div class="flex flex-col">
                            <div class="w-full lg:w-1/4">
                                <label for="section" class="tw-form-label"
                                    >Section Name<span class="text-red-500"
                                        >*</span
                                    ></label
                                >
                            </div>
        ...
        <div
            ...
            v-if="(this.standard_name == '11') | (this.standard_name == '12')"
        >
            <div class="tw-form-group w-full lg:w-1/3">
                <div class="">
                    <div class="mb-2">
                        <label for="stream" class="tw-form-label"
                            >Stream<span class="text-red-500">*</span></label
                        >
                    </div>
                    <div class="mb-2">
                        <select
                        ...
                        >
                            ...
                            <option
                                v-for="streams in streamlist"
                                v-bind:value="streams.id"
                            >
                                {{ streams.name }}
                            </option>
                        </select>
            ...
            <div
                class="tw-form-group w-full lg:w-1/3 mx-2"
                v-if="this.stream == 'others'"
            >
                <div class="">
                    <div class="mb-2">
                        <label for="other_stream" class="tw-form-label"
                            >Stream Name<span class="text-red-500"
                                >*</span
                            ></label
                        >
                    </div>
                    <div class="mb-2">
                        <input
                            type="text"
                            name="other_stream"
                            v-model="other_stream"
                            class="tw-form-control w-full"
                            placeholder="Enter Stream Name"
                        />
                    </div>
                    <span
                        v-if="errors.other_stream"
                        class="text-red-500 text-xs font-semibold"
                        >{{ errors.other_stream[0] }}</span
                    >
                </div>
            </div>
        </div>
                    ...
                    <div class="w-full lg:mr-8 md:mr-8">
                        <div class="mb-2">
                            <label for="class_teacher_id" class="tw-form-label"
                                >Class Teacher<span class="text-red-500"
                                    >*</span
                                ></label
                            >
                        </div>
                        <div class="w-full lg:w-8/12 md:w-full">
                            ...
                            <span
                                ...
                                class="text-red-500 text-xs font-semibold"
                                >{{ errors.class_teacher_id[0] }}</span
                            >
                        </div>
                    </div>
                ...
                <span v-if="errors.type" class="text-red-500 text-xs font-semibold">{{errors.type[0]}}</span>
                    ...
                    <div class="modal-body">
                        <div class="flex items-center">
                            ...
                            <div class="my-2 w-full lg:w-3/4">
                                <select
                                    v-model="subject_standard_id"
                                    name="subject_standard_id"
                                    id="subject_standard_id"
                                    class="tw-form-control w-full"
                                >
                                    <option value="" disabled="disabled">
                                ...
                                <span
                                    v-if="errors.subject_standard_id"
                                    class="text-red-500 text-xs font-semibold"
                                    >{{ errors.subject_standard_id[0] }}</span
                                >
                            </div>
                        </div>
                    </div>
                    <div class="modal-body">
                        <div class="flex items-center">
                            <div class="w-full lg:w-1/4">
                                <label
                                    for="subject_section_id"
                                    class="tw-form-label"
                                    >Section<span class="text-red-500"
                                        >*</span
                                    ></label
                                >
                            </div>
                            <div class="my-2 w-full lg:w-3/4">
                                <select
                                    v-model="subject_section_id"
                                    name="subject_section_id"
                                    id="subject_section_id"
                                    class="tw-form-control w-full"
                                >
                                    <option value="" disabled="disabled">
                                        Select Section
                                ...
                                <span
                                    v-if="errors.subject_section_id"
                                    class="text-red-500 text-xs font-semibold"
                                    >{{ errors.subject_section_id[0] }}</span
                                >
                            </div>
                        </div>
                    </div>
                    <div class="modal-body">
                        <table class="w-full border">
                            <thead class="bg-gray-400">
                                <tr class="border-b">
                                    <th
                                        class="tw-form-label text-left px-3 py-2"
                                    >
                                ...
                                >
                                    <td class="py-3 px-2">
                                        <input
                                            ...
                                            class="tw-form-control w-full"
                                            id="subject_name"
                                            v-model="subjectoption.subject_name"
                                            name="subject_name[]"
                                        />
                                        <span
                                            v-if="errors['subject_name' + k1]"
                                            class="text-red-500 text-xs font-semibold"
                                            >{{
                                                errors["subject_name" + k1][0]
                                            }}</span
                                        >
                                    </td>
                                    ...
                                    <td class="py-3 px-2">
                                        <input
                                            ...
                                            class="tw-form-control w-full"
                                            id="subject_code"
                                            v-model="subjectoption.subject_code"
                                            name="subject_code[]"
                                        />
                                        <span
                                            v-if="errors['subject_code' + k1]"
                                            class="text-red-500 text-xs font-semibold"
                                            >{{
                                                errors["subject_code" + k1][0]
                                            }}</span
                                        >
                                    </td>
                                    <td class="py-3 px-2">
                                        <select
                                            class="tw-form-control w-full"
                                            id="subject_type"
                                            v-model="subjectoption.subject_type"
                                            name="subject_type[]"
                                        >
                                            <option value="" disabled>
                                                Select Type
                                    ...
                                    <td>
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <button
                                                class="add_more px-2 text-xl"
                                                @click.prevent="addoption(k1)"
                                                v-show="
                                                    k1 ==
            ...
            <div class="flex flex-col lg:flex-row">
                <div class="w-full lg:w-1/3 md:w-1/3 flex flex-col lg:flex-row">
                    <div class="w-full lg:w-8/12 md:w-8/12">
                        <div class="mb-2">
                            <label for="class_teacher_id" class="tw-form-label"
                                >Subjects<span class="text-red-500"
                                    >*</span
                                ></label
                            >
                        </div>
        ...
        <div
            class="tw-form-group"
            v-if="(this.standard_id != '') & (this.section_id != '')"
        >
            <table
                    ...
                    <tr class="border-b" v-for="(input, index) in inputs">
                        <td class="py-3 px-2">
                            ...
                            >
                                ...
                                <option
                                    v-for="subject in subjectlist[standard_id][
                                        section_id
                                    ]"
                            ...
                            <span
                                ...
                                class="text-red-500 text-xs font-semibold"
                                >{{ errors["subject_id" + index][0] }}</span
                            >
                        </td>
                        ...
                        <td class="py-3 px-2">
                            ...
                            <span
                                ...
                                class="text-red-500 text-xs font-semibold"
                                >{{ errors["teacher_id" + index][0] }}</span
                            >
                        </td>
...
export default {
    ...
    methods: {
        ...
        addRow() {
            ...
            var standard_subject = this.groupBy(
                this.subjectlist,
                this.standard_id
            );
      ...
      return false;*/
        ...
        addStandard() {
            ...
            axios
                .post("/admin/standard/add", formData, {
        ...
        addSubject() {
            ...
            for (let i = 0; i < this.subjectoptions.length; i++) {
                if (
                    typeof this.subjectoptions[i]["subject_name"] !==
                    "undefined"
                ) {
                    formData.append(
                        "subject_name" + i,
                        this.subjectoptions[i]["subject_name"]
                    );
                } else {
                ...
                if (
                    typeof this.subjectoptions[i]["subject_code"] !==
                    "undefined"
                ) {
                    formData.append(
                        "subject_code" + i,
                        this.subjectoptions[i]["subject_code"]
                    );
                } else {
                ...
                if (
                    typeof this.subjectoptions[i]["subject_type"] !==
                    "undefined"
                ) {
                    formData.append(
                        "subject_type" + i,
                        this.subjectoptions[i]["subject_type"]
                    );
                } else {
        ...
        deleteRow(index, input) {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    axios
                        .get("/admin/subject/delete/" + subject_id)
                        .then((response) => {
                            this.success = response.data.success;
                            //console.log(this.list)
                        });
