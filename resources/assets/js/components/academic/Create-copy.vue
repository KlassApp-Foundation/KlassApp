<template>
    <div class="bg-white shadow px-4">
      ...
      <div class="modal-wrapper px-4">
            ...
            <div class="modal-wrapper px-4">
                <div class="modal-container w-full max-w-md px-8 mx-auto">
                        ...
                        <div class="flex items-center">
                            <div class="w-full lg:w-1/4">
                                <label for="subject" class="tw-form-label"
                                    >Subject Name<span class="text-red-500"
                                        >*</span
                                    ></label
                                >
                            </div>
                    ...
                    <div class="modal-body">
                        <div class="flex items-center">
                            <div class="w-full lg:w-1/4">
                                <label for="code" class="tw-form-label"
                                    >Subject Code</label
                                >
                            </div>
                            <div class="my-2 w-full lg:w-3/4">
                        ...
                        <div class="flex items-center">
                            <div class="w-full lg:w-1/4">
                                <label for="type" class="tw-form-label"
                                    >Subject Type<span class="text-red-500"
                                        >*</span
                                    ></label
                                >
                            </div>
        ...
        <div
            class="tw-form-group"
            showv-if="this.standard_id != '' & this.section_id != '' "
        >
            <div class="flex flex-col lg:flex-row">
        ...
        <div
            class="w-1/2 flex flex-wrap"
            v-if="(this.standard_id != '') & (this.section_id != '')"
        >
            <div
                class="w-full lg:w-1/2 md:w-1/2 my-2 relative"
                v-for="subjects in subjectlist[this.standard_id][
                    this.section_id
                ]"
            >
                <div class="flex items-center">
                    <input
                        ...
                        type="checkbox"
                        :value="subjects.id"
                        v-on:change="addRow(subjects.id)"
                    />
            ...
            <div class="w-full lg:w-1/2 md:w-1/2 my-2 relative">
                <div class="flex items-center">
                    <a
                        href="#"
                        class="no-underline text-white px-4 flex items-center blue-bg py-1 justify-center rounded"
            ...
            >
                <thead class="bg-gray-400">
                    <tr class="border-b">
                        ...
                        <template
                            v-if="
                                (this.standard_name == '12') |
                                    (this.standard_name == '11')
                            "
                        >
                            <th
                                class="tw-form-label py-2"
                                showv-if="this.standard_name != '12'"
                            >
                                Subject Type<!-- <span class="text-red-500">*</span> -->
                            </th>
                        </template>
                        <th class="tw-form-label py-2">
                            Delete<!-- <span class="text-red-500">*</span> -->
                        </th>
                    ...
                    <tr class="border-b" v-for="(input, index) in inputs">
                        ...
                        <td class="py-3 px-2">
                            ...
                            >
                                ...
                                <option value="group_dedicated_subject">
                                    Dedicated Subject for group
                                    (eg:biology,cs,Business Maths)
                                </option>
                            </select>
                            <span
                                v-if="errors['subject_type' + index]"
                                class="text-red-500 text-xs font-semibold"
                                >{{ errors["subject_type" + index][0] }}</span
                            >
                        </td>
                        ...
                        <td>
                            ...
                            >
                                <svg
                                    ...
                                    viewBox="0 0 512 512"
                                    xml:space="preserve"
                                    class="w-4 h-4 fill-current text-black-500"
                                >
                                    <g data-v-689010ab="">
                                        <g data-v-689010ab="">
                                            <g data-v-689010ab="">
    ...
    addRow()
    {
      ...
      return false;*/
        ...
        addSubject() {
            ...
            axios
                .post("/admin/subjects/add", formData, {
                    headers: { "Content-Type": "multipart/form-data" },
                })
                .then((response) => {
                    this.success = response.data.success;
