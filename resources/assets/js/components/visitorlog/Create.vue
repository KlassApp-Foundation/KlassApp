                    ...
                    <div class="w-full lg:w-1/3 md:w-1/2">
                        <div class="tw-form-group w-full lg:w-3/4 md:w-5/6">
                            <div class="">
                                ...
                                <div class="mb-2">
                                    <input type="date" name="date_of_visit" v-model="local_date_of_visit" class="tw-form-control w-full" id="date_of_visit">
    ...
    export default {
        ...
        data(){
            return{
                ...
                standardLink_id:'',
                employee_id:'',
                local_date_of_visit: this.date_of_visit,
                entry_time:'',
                exit_time:'',
                remark:'',
                errors:[],
        ...
        methods:
        {
            ...
            addVisitorLog()
            {
                ...
                formData.append('date_of_visit',this.local_date_of_visit);          
