...
return new class extends Migration
{
    private const ROSTER = [
        ['NIWANDINDA PAUSON',   'P.4 WEST P.5 EAST',    'SCIENCE SCIENCE'],
        ['AINEBYOONA EMILY',     'P.2 EAST P.2 WEST P.2','MTC MTC LIT II'],
        ...
        ['NTANGANZWA FRED',      'P.3',                  'LIT I'],
        ['ABAHO DELIGHT',        'P.1 P.2 WEST P.2 EAST','RE LIT I'],
        ['KYOSHABIRE MERCY',     'P.1 P.3',              'LIT II LIT II'],
        ['AKELLO FIONA OCAN',    'P.2 EAST P.2 WEST P.3','RE RE RE'],
        ...
        ['AHUMUZA DOREEN',       'P.1 P.2',              'LIT I ENGLISH'],
        ...
        ['AKAMPURIRA JUSTUS',    'P.7 EAST P.7 WEST',    'SST SST'],
        ['AMATSIKO NICHOLAS',    'P.7 EAST P.7 WEST',    'MTC MTC'],
    ...
    public function up(): void
    {
        ...
        foreach (self::ROSTER as $row) {
            ...
            foreach ($classNames as $i => $cn) {
                ...
                if (!$stdLink) { echo "  SKIP stdLink: {$cn}\n"; $skipped++; continue; }
                ...
                if (!$subject) { echo "  SKIP subject: {$subjects[$i]} ({$sn}) sec {$secId}\n"; $skipped++; continue; }
    ...
    private function resolveSubject(string $name): string
    {
        $map = [
            ...
            'SST' => 'SST', 'RE' => 'RELIGIOUS EDUCATION', 'LIT I' => 'LITERACY I',
            'LIT II' => 'LITERACY II',
        ];
